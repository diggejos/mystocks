                    ...
                    html.Div([
                        ...
                        dcc.Dropdown(
                            ...
                            options=[
                                ...
                                {'label': 'Marathon (MARA)', 'value': 'MARA'},
                                {'label': 'WTEC ETF (WTEC)', 'value': 'WTEC.SW'},
                                {'label': 'Netflix (NFLX)', 'value': 'NFLX'},
                                {'label': 'Ulta Cosmetics (ULTA)', 'value': 'ULTA'},
                                {'label': 'Spotify (SPOT)', 'value': 'SPOT'},
                                {'label': 'MSCI WORLD ETF (URTH)', 'value': 'URTH'},
                                {'label': 'Paypal (PYPL)', 'value': 'PYPL'},
                                {'label': 'Sonova (SOON)', 'value': 'SOON.SW'},
                                {'label': 'Novucure (NVCR)', 'value': 'NVCR'},
                                {'label': 'Bitcoin (BTC-USD)', 'value': 'BTC-USD'},
                                {'label': 'Uber (UBER)', 'value': 'UBER'},
                                {'label': 'NU Holdings (NU)', 'value': 'NU'},
                                {'label': 'ARM Holdings (ARM)', 'value': 'ARM'},
                                {'label': 'Builders First Source (BLDR)', 'value': 'BLDR'}
                            ],
                            value=['AAPL', 'AMZN'],
                            multi=True,
